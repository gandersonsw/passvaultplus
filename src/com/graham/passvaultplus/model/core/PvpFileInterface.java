...
public class PvpFileInterface {
			...
			while (badEncryption) {
				...
				if (isEncrypted(path)) {
					...
					try {
						...
						context.notifyBadException(
								"Java Cryptography Extension (JCE) Unlimited Strength Jurisdiction Policy", e, true);
						throw new RuntimeException(e);
	...
	public void load(PvpDataInterface dataInterface) throws UserAskToChangeFileException {
		try {
			...
			if (types == null) { // TODO this should be handled better
